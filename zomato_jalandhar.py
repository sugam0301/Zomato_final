...
X_train, X_test, y_train, y_test = train_test_split(train.drop(columns=["reviews"]),train["reviews"], test_size=0.20, random_state=10)
...
from sklearn.model_selection import train_test_split
X_train, X_test, y_train, y_test = train_test_split(temp.drop(columns=["Ratings"]),temp["Ratings"], test_size=0.2, random_state=10001)
